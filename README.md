...
从单张图片生成 360 度多视图。→ [示例代码](src/main/com/visvise/sdk/examples/Gen360Example.java)
...
从图片/多视图生成高精度 3D 模型（node_type=3）。→ [示例代码](src/main/com/visvise/sdk/examples/GenHighModelExample.java)
...
中模要求四视图全部必传（node_type=11）。→ [示例代码](src/main/com/visvise/sdk/examples/GenMidModelExample.java)
...
低模只需主视图（node_type=13）。→ [示例代码](src/main/com/visvise/sdk/examples/GenLowModelExample.java)
...
对模型进行布线优化（node_type=10）。→ [示例代码](src/main/com/visvise/sdk/examples/GenMeshRefineExample.java)
...
对高面数模型进行拓扑优化（node_type=1）。→ [示例代码](src/main/com/visvise/sdk/examples/GenRetopologyExample.java)
...
生成多级细节模型（node_type=2），支持抽卡。默认抽卡次数为 3。→ [示例代码](src/main/com/visvise/sdk/examples/GenLODExample.java)
...
自动 UV 展开（node_type=9）。→ [示例代码](src/main/com/visvise/sdk/examples/GenUVExample.java)
...
为模型生成贴图纹理（node_type=8）。→ [示例代码](src/main/com/visvise/sdk/examples/GenTextureExample.java)
...
自动为模型生成骨骼（node_type=5）。SDK 自动将模型文件与参数 JSON 打包成 zip 上传，无需手动准备 zip 包。→ [示例代码](src/main/com/visvise/sdk/examples/GenRiggingExample.java)
...
自动绑定蒙皮权重（node_type=6）。SDK 自动将模型文件与参数 JSON 打包成 zip 上传。→ [示例代码](src/main/com/visvise/sdk/examples/GenSkinningExample.java)
...
从视频中提取动作驱动 3D 模型（node_type=4）。→ [示例代码](src/main/com/visvise/sdk/examples/GenVideoMotionExample.java)
...
通过提示词生成动画，一次返回 4 个模型供抽卡（node_type=4）。→ [示例代码](src/main/com/visvise/sdk/examples/GenTextMotionExample.java)
...
从参考图生成 Pose 模型（最多 10 张图片）。→ [示例代码](src/main/com/visvise/sdk/examples/GenPoseExample.java)
...
对图生 360 输出的多视图进行组件分割（node_type=14，SSE 协议）。生成的分割资产 `model_id` 可作为图生中模/低模的 `segmentModelID` 输入。→ [示例代码](src/main/com/visvise/sdk/examples/GenSegment2DExample.java)
